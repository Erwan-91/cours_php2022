            ...
            <main class="container-fluid">
                ...
                <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>Incrémentation: ajoute une unité à la variable . Il existe deux possibilités , la préincrémentation, qui ajoute 1 avant d'utiliser la variable , et la postincrémentation qui ajoute 1 après avoir utilisé la variable.
                                        ...
                                        echo "<br><div class=\" alert alert-success w-50\">" .
                                            $var++ . " et, avec post-incrémentation = " . $var . "<br> Avec la pré-incrémentation = " . ++$var . "</div>";
                                        ?>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="col-sm-12 col-md-3">
                        ...
                        ?>
                        <p>Ici la variable $b nous renvoie le booléen 1 qui signifie vrai. Dans le cas où la variable doit renvoyer un booléen faux (False), il y aura une chaine vide à la place de 0.</p>
                    </div>
                    <hr>
                    <div class="col-sm-12">
                        <h3 class="text-center">C. Les opérateurs booléens</h3>
                        <p>Quand ils sont associés, les opérateurs booléens servent à écrire des expressions simples ou complexes, qui sont évalués par une valeur booléenes TRUE ou FALSE. Ils seront utilisés dans les instructions conditionnelles</p>
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th scope="col">Opérateurs</th>
                            ...
                            <tbody>
                                <tr>
                                    <th scope="" row>===</th>
                                    <td>
                                        Teste l'égalité de deux valeurs. L'expression $a == $b TRUE si la valeur de $a est égale à celle de $b et FALSE dans le cas contraire : <br>
                                        $a = 345;<br>
                                        $b = "345";<br>
                                        $c = ($a==$b);<br>
                                        $c est un booléen qui vaut TRUE car dans un contexte de comparaison numérique, la chaine "345" est évaluée comme le nombre 345. Si $b= "345 éléphants" nous obtenons le même résultat
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">!= ou &lt;</th>
                                    <td>
                                        ...
                                        L'éxpression $a != $b TRUE si la valeur de $a est différente de celle de $b et FALSE dans le cas contraire.
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">===</th>
                                    <td>
                                        Teste l'identité de deux valeurs et des types de deux expressions. <br>
                                        L'éxpression $a ====; $b TRUE si la valeur de $a est égale à celle de $b mais à condition que les types des deux expressions soient identiques. Elle vaut FALSE dans le cas contraire : <br>
                                        $a = 345;<br>
                                        $b = "345";<br>
                                        $c = ($a===$b);<br>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        L'expression $a !== $b vaut TRUE si la valeur de $a est différente de celle de $b et que leurs types sont différents. Dans le cas contraire elle vaut FALSE : <br>
                                        $a = 345;<br>
                                        $b = "345";<br>
                                        $c = ($a!==$b);<br>
                                ...
                                <tr>
                                    <th scope="row">=></th>
                                    <td>
                                        Avec $a=>$b, retourne 0 ou 1 respectivement si $a<$b, $a=$b ou $a>$b ($a et $b peuvent être des chaînes).
                                    </td>
                                </tr>
                            </tbody>
                        </table>
