...
$database = 'entreprise';
$user = 'root';
$psw = ''; // sur mac, c'est root et sur windows, c'est vide
            ...
            <main class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        echo "<table class=\"table table-striped table-primary table striped\">";
                        echo "<thead><tr><th scope = \"col\">ID</th><th scope = \"col\">Civilité</th><th scope = \"col\">Prenom</th><th scope = \"col\">Nom</th><th scope = \"col\">Sexe</th><th scope = \"col\">Service</th><th scope = \"col\">Date d'embauche</th><th scope = \"col\">Salaire</th><th scope = \"col\">fiche</th></tr></thead>";
                        while ($ligne = $requete->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo "<td>" . "<a href=\"03-fiche-employes.php?id=" . $ligne['id_employes'] . "\" class=\"text-black\">Voir sa fiche</a>" . "</td>";
                        }
                        echo "</table>";
                        ?>
