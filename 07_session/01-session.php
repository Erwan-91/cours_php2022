...
<body class="bg-light">
    ...
    <div class="jumbotron bg-dark text-white text-center">
        ...
        <p class="lead">Une session est un système mis en oeuvre dans le code PHP permettant de conserver sur le serveur, dans un fichier temporaire, des informations relatives à un internaute.
            ...
            L'avantage d'une session c'est que les données seront enregistrées dans un fichier sur le serveur disponible et cumulable sur l'ensemble des pages durant toute la navigation de l'internaute.</p>
